...
- Age group patterns  
- Income distribution  
- Customer segments (Premium, Regular, New)

###  2. Sales Trends
- Monthly - yearly sales    

###  3. Geographic Analysis
- City/state/country-wise sales  
...
###  5. Payment & Shipping Insights
- Most used payment methods  
- Delivery issues based on order status  

###  6. RFM Segmentation
RFM model assigns customers into segments like:
